...
본 프로젝트에서는 **어벤져스: 엔드게임** 리뷰 데이터를 네이버, 로튼토마토, ,GG에서 크롤링하여 수집하였습니다.  
---
...
- **로튼토마토 링크** https://www.rottentomatoes.com/m/avengers_endgame/reviews?type=user
- **크롤링 규모**: 네이버 총 300건, 로튼토마토 총 1018건, GG 총 M건의 리뷰
...
| Column | 예시                                     | 설명                                       |
|:------:|:---------------------------------------:|:------------------------------------------:|
| `date`   | `2021-11-06`                    | 리뷰 작성일자                     |
| `rating` | `"4.5"`              | 5점 만점 기준으로 표시된 평점             |
| `review` | `Probably the last good Marvel movie made. No Way Home might turn out decent, but otherwise nothing s...` | 실제 사용자 리뷰 내용                      |
